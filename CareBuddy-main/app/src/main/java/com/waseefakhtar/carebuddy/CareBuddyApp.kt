...
import com.waseefakhtar.carebuddy.feature.addmedication.navigation.AddMedicationDestination
...
import com.waseefakhtar.carebuddy.navigation.CareBuddyNavHost
import com.waseefakhtar.carebuddy.navigation.CareBuddyTopLevelNavigation
import com.waseefakhtar.carebuddy.navigation.TOP_LEVEL_DESTINATIONS
import com.waseefakhtar.carebuddy.navigation.TopLevelDestination
import com.waseefakhtar.carebuddy.ui.theme.CareBuddyTheme
import com.waseefakhtar.carebuddy.util.SnackbarUtil
...
fun CareBuddyApp(
    ...
    CareBuddyTheme {
        ...
        Surface(
            ...
            val careBuddyTopLevelNavigation = remember(navController) {
                CareBuddyTopLevelNavigation(navController)
            }
            ...
            Scaffold(
                ...
                floatingActionButton = {
                    ...
                    AnimatedVisibility(
                        ...
                        content = {
                            CareBuddyFAB(navController, analyticsHelper)
                        }
                    )
                },
                bottomBar = {
                    Box {
                        ...
                        AnimatedVisibility(
                            ...
                            content = {
                                CareBuddyBottomBar(
                                    onNavigateToTopLevelDestination = careBuddyTopLevelNavigation::navigateTo,
...
@Composable
private fun CareBuddyBottomBar(
...
@Composable
fun CareBuddyFAB(navController: NavController, analyticsHelper: AnalyticsHelper) {
...
fun DefaultPreview() {
    ...
    CareBuddyTheme {
        CareBuddyApp(analyticsHelper = AnalyticsHelper(context = context))
    }
}
